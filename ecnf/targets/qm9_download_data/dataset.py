from ecnf.targets.qm9_download_data.data.args import init_argparse
from ecnf.targets.qm9_download_data.data.utils import initialize_datasets
import numpy as np
...
if __name__ == '__main__':
    qm9pos_download_and_save_data("../target_energy/data")